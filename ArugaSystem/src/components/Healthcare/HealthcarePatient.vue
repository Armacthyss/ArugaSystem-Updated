    ...
    // placeOfBirth, address, healthCenter, barangay, sex, parents[]
    // (parentID, relationshipType, isPrimaryContact,
    // canReceiveNotifications — no parent name, so no Parent column
    // here without an extra lookup). No medical fields exist on this
    // model at all, confirming the Medical Information gap below.
    // ─────────────────────────────────────────────────────────────
